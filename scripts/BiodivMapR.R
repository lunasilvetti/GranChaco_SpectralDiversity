...
# ============================================================
#
# This analysis evaluates how within-cluster variation changes
# as the number of clusters increases. The elbow criterion is
# used to identify a point beyond which additional clusters
# provide only marginal reductions in within-cluster variation.
#
# The selected number of clusters is subsequently used in the
# spectral-species analysis performed with biodivMapR.
# ============================================================


# Load k-means information generated by biodivMapR
# Kmeans_info.RData contains the centroid information generated
# during the biodivMapR workflow.
load("./out/biodivMapR/Kmeans_info.RData")


# Extract centroid information
# The first iteration of the centroid matrix is used for
# evaluating the relationship between the number of clusters
# and within-cluster variation.
X <- Kmeans_info$Centroids[[1]]

# Define the range of cluster numbers
# The analysis evaluates solutions ranging from 2 to 50 clusters.
K_values <- 2:50
