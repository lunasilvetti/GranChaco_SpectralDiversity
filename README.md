...
<p align="center">
<img src="Images/distance_relationship_plot.png" alt="Descripción" width="410"/>
<img src="Images/quantile_regression_plot.png" alt="Descripción" width="450"/>
</p>
...
---
### ▶️ Determination of the optimal number of clusters
```r
# Load k-means information generated by biodivMapR
# Kmeans_info.RData contains the centroid information generated during the biodivMapR workflow.
...
out/BiodivMapR
 ...
 ├── 📄 nmds_plot.png          # NMDS of spectral species centroids 
 ├── 📄 number_clusters.png    # Within-cluster sum of squares (WSS) for different numbers of clusters
